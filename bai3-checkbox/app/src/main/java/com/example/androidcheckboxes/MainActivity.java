...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CheckBox cb_android = findViewById(R.id.cb_android);
        CheckBox cb_ios = findViewById(R.id.cb_ios);
        CheckBox cb_window = findViewById(R.id.cb_window);
        CheckBox cb_rim = findViewById(R.id.cb_rim);
